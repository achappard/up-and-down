...
<head>
    ...
    <style type="text/css">
        ...
        a {color: #3F9FFF;text-decoration: none;text-decoration:none!important;}
        /*STYLES*/
        ...
        @media only screen and (max-width: 640px) {
            a[href^="tel"], a[href^="sms"] {
                ...
                color: #3F9FFF; /* or whatever your want */
                pointer-events: none;
                cursor: default;
            }
                    ...
                    <td width="100%">
                        <table bgcolor="#e8eaed" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            ...
                            <tr>
                                <!-- start of image -->
                                <td align="center">
                                    <a target="_blank" href="#"><img width="600" border="0" height="150" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="{{ URL::asset('upAndDown/img/header-mail-download.png') }}" class="logo"></a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
