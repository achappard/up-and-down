...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('admin-theme/bower_components/AdminLTE/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
    <link rel="stylesheet"  href="{{ URL::asset('admin-theme/bower_components/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}">
    <link rel="stylesheet"  href="{{ URL::asset('admin-theme/bower_components/AdminLTE/dist/css/AdminLTE.min.css') }}">
    <link rel="stylesheet"  href="{{ URL::asset('admin-theme/bower_components/AdminLTE/dist/css/skins/skin-blue.min.css') }}">
